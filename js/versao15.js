...
function create_spotlights(){
  ...
  targetObject.position.set(200,00,0);

	spotlight1 = new THREE.SpotLight(0xffffff, spotlightIntensity, 200, (Math.PI/2), 0, 1);
	spotlight1.position.set(-100, 20, -50);

	spotlight2 = new THREE.SpotLight(0xffffff, spotlightIntensity, 200, (Math.PI/2), 0, 1);
	spotlight2.position.set(-100, 20, 50);

	spotlight3 = new THREE.SpotLight(0xffffff, spotlightIntensity, 200, (Math.PI/2), 0, 1);
	spotlight3.position.set(100, 20, -50);

	spotlight4 = new THREE.SpotLight(0xffffff, spotlightIntensity, 200, (Math.PI/2), 0, 1);
	spotlight4.position.set(100, 20, 50);
