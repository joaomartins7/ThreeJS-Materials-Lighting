...
function create_spotlights(){
  var distanceLight = 110;
	spotlight1 = new THREE.SpotLight(0xffffff, 5, 200, (Math.PI/2), 0, 1);
	spotlight1.position.set(-distanceLight, 20, -50);

	spotlight2 = new THREE.SpotLight(0xffffff, 5, 200, (Math.PI/2), 0, 1);
	spotlight2.position.set(-distanceLight, 20, 50);

	spotlight3 = new THREE.SpotLight(0xffffff, 5, 200, (Math.PI/2), 0, 1);
	spotlight3.position.set(distanceLight, 20, -50);

	spotlight4 = new THREE.SpotLight(0xffffff, 5, 200, (Math.PI/2), 0, 1);
...
function createHolofotes(){
    createHolofote1();  //baixo atras esquerda
    createHolofote2();  //baixo frente esquerda
    createHolofote3();  //baixo atras direita
    createHolofote4();  //baixo frente direita

}


function createHolofote1(){
